...
function GUI_CLASS() {
	...
	this.draw_helpers = function () {
		...
		var html = '';
		var colors_data = [
            ['#fafafa', '#ededed', '#bbbbbb', '#72767b', '#393f44', '#030303'],
            ['#ff0000', '#cc0000', '#a30000', '#8b0000', '#470000', '#2c0000'],
            ['#fbdebf', '#f7bd7f', '#f39d3c', '#ec7a08', '#b35c00', '#773d00'],
            ['#fbeabc', '#f9d67a', '#f5c12e', '#f0ab00', '#b58100', '#795600'],
            ['#e4f5bc', '#c8eb79', '#ace12e', '#92d400', '#6ca100', '#486b00'],
            ['#9ecf99', '#6ec664', '#3f9c35', '#2d7623', '#1e4f18', '#0f280d'],
            ['#7dbdc3', '#3a9ca6', '#007a87', '#005c66', '#003d44', '#001f22'],
            ['#7cdbf3', '#35caed', '#00b9e4', '#008bad', '#005c73', '#002d39'],
            ['#bee1f4', '#7dc3e8', '#39a5dc', '#0088ce', '#00659c', '#004368'],
            ['#c7bfff', '#a18fff', '#8461f7', '#703fec', '#40199a', '#1f0066'],
		];
